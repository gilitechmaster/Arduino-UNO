...
//물방울 액체적재센서 1개, 스포이드 양 = 50mg(포켓저울로 측정함)
...
//실험 3.
//물 50mg + 소금 0mg(0개) = 2199(값 변위 0) = 농도 0%
//물 50mg + 소금 1.5mg(10개) = 2100(값 변위 -100) = 농도 2.9%
//물 50mg + 소금 3mg(20개) = 2090(값 변위 -20) = 농도 5.67% 

//실험 4.
//물 50mg + 0mg(0개) = 2100(값 변위 0) = 농도 0%
//물 50mg + 2.25mg(15개) = 2090(값 변위 -10) = 농도 4%
//물 50mg + 4.5mg(30개) = 2060(값 변위 -30) = 농도 8%
