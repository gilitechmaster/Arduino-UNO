...
//실험 6.
//물 70mg + 10M옴 = 3030
//물 70mg + 10M옴 + 고은소금 1작은삽 = 3010 (변위 0) = 농도 12.5%
//물 70mg + 10M옴 + 고은소금 2작은삽 = 2980 (변위 -30) = 농도 22.2%
//물 70mg + 10M옴 + 고은소금 3작은삽 = 2977 (변위 -3) = 농도 30.0%
//물 70mg + 10M옴 + 고은소금 4작은삽 = 2977 (변위 0) = 농도 36.3%
//물 70mg + 10M옴 + 고은소금 6작은삽 = 2980 (변위 +3) = 농도 46.15%
//물 70mg + 물 50mg + 10M옴 + 고은소금 6작은삽 = 3030 (변위 +50) = 농도 33.3%

//실험 6을 통해서 알게되었는데, 10mg소금을 센서에 적재를 하면
//물 70mg에서 합을 이루지 않고 소금+물의 무게는 그대로 70mg이다.
//그러면 고찰할 것은
...
//그러면 물은 70mg 상태보다 이하에서 소금물이 됨을 알 수 있다.
//즉, 고은소금 6삽에 물은 70mg 보다 적은 상태이다.
//물을 적재하여 총합 156mg에 맞추어볼 때
//값은 3030으로 증가함을 확인할 수 있었다.
